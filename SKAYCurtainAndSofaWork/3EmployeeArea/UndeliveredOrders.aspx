<%@ Page Title="" Language="C#" MasterPageFile="~/3EmployeeArea/EmployeeArea.master" AutoEventWireup="true" CodeFile="UndeliveredOrders.aspx.cs" Inherits="_3EmployeeArea_UndeliveredOrders" %>
                    ...
                    <asp:Repeater ID="rptrOrders" runat="server" OnItemDataBound="rptrOrders_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-uppercase text-end"  style="color: #f44336;"><strong><%# Eval("Appointmet_Date").ToString() == "" ? "New" : Eval("Appointmet_Date") %></strong></td>
                                ...
                                <div class="modal fade"  data-bs-backdrop="static" data-bs-keyboard="false" id="exampleModal<%# Eval("Custom_Phone_Number") %>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary" style=" color: #e1e1e1;">
                                                        ...
                                                        <div class="pt-4">
                                                            ...
                                                            <div class="p-1">
                                                                ...
                                                                <div class="d-flex justify-content-between pt-2">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="input-group input-group-sm">
                                                                            <asp:TextBox ID="tbHoldingAmount" CssClass="form-control form-control-sm" MaxLength="7"  disabled="disabled" runat="server" onkeypress="return onlyNumberKey(event)" Text='<%# Eval("Holding_Amount") %>'></asp:TextBox>
                                                                ...
                                                                <div class="d-flex justify-content-between pt-2">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="input-group input-group-sm">
                                                                            <asp:TextBox ID="tbAppoointment" runat="server" CssClass="form-control form-control-sm"  disabled="disabled" TextMode="Date" Text='<%# Eval("Appointmet_Date").ToString() == ""? "Pendding": Eval("Appointmet_Date") %>'></asp:TextBox>
                                                                            </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mt-2">
                                                                <label>Comment about the order</label>
                                                                <asp:TextBox id="tbOrderId" runat="server" rows="2" TextMode="Multiline" class="form-control" maxlength="199" disabled="disabled" Text='<%# Eval("Comment") %>'></asp:TextBox>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
