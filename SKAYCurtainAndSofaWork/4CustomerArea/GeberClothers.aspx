<%@ Page Title="" Language="C#" MasterPageFile="~/4CustomerArea/CustomerArea.master" AutoEventWireup="true" CodeFile="GeberClothers.aspx.cs" Inherits="_4CustomerArea_GeberClothers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container card mainContent">
            
        <div class="d-flex justify-content-center border-bottom">
            <div>
                <h5 class="text-center"> ከስር ያሉ የመጋረጃ ጨርቆች ገበር ብቻ የያዙ የያዙ ናቸው ዋጋቸው ደሞ <strong>በ ሜትር</strong> ነው። </h5>
            
                <p class="text-center"> <strong>N.B</strong> እነዚህ ጨርቆች ገበር ብቻ ያላቸው ጨርቆች ናቸው፤ ስለዚ ገበር ብቻ ያለው መጋረጃ ከፈለጉ
                     <strong>'ትዛዝ ማዘጋጃ'</strong> የምል ማፈንጠርያ በመጫን ይዘዙ።  </p>
            </div>
        </div>
                                ...
                                <div id="carouselExampleIndicators<%# Eval("IdNumber") %>" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-item active">
                                        ...
                                        <div class="m-2">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="font-weight-bold">* <%# Eval("ClothCatagory").ToString() == "Sofa"? " ጨርቁ ምን ልያሰራ ይችላል？ ":" የጨርቁ ይዘት " %> </span><span class="font-weight-bold"><%# Eval("SubCatagory").ToString() == "Inner Only"? " ገበር ብቻ":Eval("SubCatagory")  %></span>
                                            </div>
                                            <hr />
                                            <div class="d-flex justify-content-between">
                                                <span class="font-weight-bold">* ኣቅርቦት（Availablity）</span> <span class="font-weight-bold"><%# Eval("Width") %> ሜ</span>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="font-weight-bold">* የዋና ጨርቅ ዋጋ </span><span class="font-weight-bold"> ዋና ጨርቅ የለውም</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <span class="font-weight-bold">* የገበር ዋጋ</span> <span class="font-weight-bold"> <%# Eval("PricePerMeter") %> ETB</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
