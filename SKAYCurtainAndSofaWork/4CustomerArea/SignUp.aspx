<%@ Page Title="" Language="C#" MasterPageFile="~/4CustomerArea/CustomerArea.master" AutoEventWireup="true" CodeFile="SignUp.aspx.cs" Inherits="_4CustomerArea_SignUp" %>
            ...
            <div class="col-md-8 mb-3">
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="border-top card-body text-center cont-bg">
                        <p class=" p-1">Alreaady have an account? <a href="LogIn.aspx" class="text-decoration-none">Login!</a></p>
                    </div>
