<%@ Page Title="" Language="C#" MasterPageFile="~/4CustomerArea/CustomerArea.master" AutoEventWireup="true" CodeFile="LogIn.aspx.cs" Inherits="_4CustomerArea_LogIn" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
     <div class="container mainContent" style="margin-top: 100px;">
        <div class="row justify-content-center">
            ...
            <div class="border-top card-body text-center">
                <p class=" p-1">haven't an account? <a href="SignUp.aspx" class="text-decoration-none">Create Account!</a></p>
            </div>
            <!-- card-body end .// -->
                </div>
                <!-- card.// -->
